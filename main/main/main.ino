...
void loop()
{
    ...
    //center_servo.run_to(358/2);

    //servo_1.quick_up(1500);
    //servo_2.slow_up(1500);
    //servo_3.slow_up(1500);
    //center_servo.init();

    //sucker11.suck();
    //servo_1.quick_down(960);
    //servo_1.slow_down(1500);
    //delay(4000);
    //servo_1.quick_up(960);
    //delay(1000);
    //sucker12.suck();
    //servo_1.quick_down(960);
    //servo_1.slow_down(1500);
    ...
    // center_servo.reset();
    // center_servo.run_to(358/2);
    // center_servo.run_to(0/2);
    // center_servo.run_to(180/2);
    delay(5000);

    // center_servo.run_to(270/2);
    // center_servo.run_to(180/2);
    // servo_2.slow_up(1500);
    // delay(2000);
    // claw31.release();
    ...
    // center_servo.reset();
    // delay(5000);
    // center_servo.run_to(90/2);
    // My_motor.run_forward(20);
    // delay(1000);
    // My_motor.stop();
    //  提升舵机
    // servo_1.slow_up(4000);
    // servo_2.slow_up(4000);
    // servo_3.slow_up(4000);

    /*
    // 中央舵机复位
    center_servo.reset();
    //吸取第一个
    center_servo.run_to(12/2);
    servo_1.slow_down(960);
    sucker11.suck();
    sucker12.suck();
    delay(4000);
    servo_1.slow_up(2000);

    //吸取第二个
    center_servo.run_to(64/2);
    servo_2.slow_down(960);
    sucker21.suck();
    sucker22.suck();
    delay(4000);
    servo_2.slow_up(2000);

    //吸取第三个
    center_servo.run_to(108/2);
    servo_3.slow_down(960);
    sucker31.suck();
    sucker32.suck();
    delay(4000);
    servo_3.slow_up(2000);

    My_motor.run_backward(98);
    delay(9750);
    My_motor.stop();
    delay(1000);
    ...
    // center_servo.run_to(30/2);
    // servo_1.slow_down(1000);
    sucker11.suck();
    sucker12.suck();
    delay(3000);
    //servo_1.slow_up(1500);

    //center_servo.run_to(60/2);
    //servo_2.slow_down(1000);
    sucker21.suck();
    //claw22.grab();
    delay(3000);
    //servo_2.slow_up(1500);
